...
inline fun <reified T> Bundle.getByType(key: String): T? {
    ...
    return when {
        ...
        cls == Int::class.javaObjectType -> getInt(key)
        cls == Long::class.javaObjectType -> getLong(key)
        cls == Float::class.javaObjectType -> getFloat(key)
        cls == Double::class.javaObjectType -> getDouble(key)
        cls == Boolean::class.javaObjectType -> getBoolean(key)
